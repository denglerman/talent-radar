...
export default function CandidateRadarVisualization({ candidates, selectedId, onSelect }: Props) {
  ...
  const candidatePositions = useMemo(() => {
    return candidates.map((c) => {
      const r = minR + (1 - c.mobility_score / 100) * (maxR - minR);
      ...
      >
        ...
        <g clipPath="url(#candidateSemiClip)">
          ...
          {(() => {
            ...
            const sweepFlag = sweepDir === 1 ? 1 : 0;
            return (
              <g>
                <path
